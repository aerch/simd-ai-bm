...
inline void avx2_ai_epx16_bm( thread_data_t *td,  pc_data_t *pc, int16_t *si16, int32_t vector_offset ) {
	int64_t i;
	int16_t *p __attribute__((aligned(32)));
	__m256i vi;
...
void* avx2_ai_epx16_bm_thread( void *arg ) {
	...
	avx2_ai_epx16_bm( td, &pc[ DSP_PC ], si16, 16 );
