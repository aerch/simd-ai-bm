...
inline void sse4_1_ai_ps32_bm( thread_data_t *td,  pc_data_t *pc, float *ps32, int32_t vector_offset ) {
	int64_t i;
...
void* sse4_1_ai_ps32_bm_thread( void *arg ) {
	...
	sse4_1_ai_ps32_bm( td, &pc[ DSP_PC ], ps32, 4 );
...
void* sse4_1_ai_ps32_cpu_bm_thread( void *arg ) {
	...
	sse4_1_ai_ps32_bm( td, &pc[ CPU_PC ], ps32, 0 );
